...
public class P extends JFrame implements ActionListener {
	...
	public void pop() {
		...
		txtpnPerpendicularLines.setText("                                                         Slope-Intercept Lines 1.1");
		contentPane.add(txtpnPerpendicularLines);
		
		lblThisLessonWill = new JLabel("This lesson will teach you how to find the slope-intercept form of a line using points.");
